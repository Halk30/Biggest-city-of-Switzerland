...
var style__3 = function(feature, resolution){
    ...
    if (value >= 11184.000000 && value <= 43723.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 43723.000000 && value <= 81691.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 81691.000000 && value <= 139111.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 139111.000000 && value <= 201741.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 201741.000000 && value <= 434008.000000) {
            style = [ new ol.style.Style({
